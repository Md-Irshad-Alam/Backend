...
Router.route('/update-color/:id').put([updatecolorvalidation, validate], updatecolor)
Router.route('/get-color').get(getallcolor)
Router.route('/delete-color/:id').delete([deletecolorvalidation, validate], deletecolor)
