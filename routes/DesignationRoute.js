...
Router.route('/update-designation/:id').put([updatedesignationvalidation, validate], updateDesignation)
Router.route('/get-designation').get(getallDesignation)
Router.route('/delete-designation/:id').delete([deletedesignationvalidation, validate], deleteDesignation)
