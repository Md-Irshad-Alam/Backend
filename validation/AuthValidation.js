...
exports.registervalidation = [
  ...
  body('email')
    .notEmpty()
    .withMessage('Provide your email id')
    .isEmail()
    .withMessage('Provide valid email id')
    .custom(async (value) => {
  ...
  body('mobile')
    .notEmpty()
    .withMessage('Provide your mobile number')
    .isMobilePhone()
  ...
  //   .notEmpty()
  //   .withMessage('Provide your password again')
  //   .custom((value, { req }) => {
...
exports.verifyOtpvalidation = [
  ...
  body('otp')
    .notEmpty()
    .withMessage('Provide otp')
    .isLength({ max: 6, min: 6 })
    .withMessage('Provide valid otp'),
];
...
exports.deleteuservalidation = [
  param('id')
    .notEmpty()
    .withMessage('Provide employee id')
    .custom(async (value) => {
      await AuthModel.findOne({ _id: value, role: 'employee' }).then(
        (result) => {
          if (result) {
            return true;
          } else {
