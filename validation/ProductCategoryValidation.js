...
exports.ProductCategoryValidation = [
  param('id')
    .notEmpty()
    .withMessage('Provide Product Category id')
    .custom(async (value) => {
  ...
  body('category')
    .notEmpty()
    .withMessage('Provide the Category name')
    .custom(async (value) => {
  ...
  body('type')
    .notEmpty()
    .withMessage('Provide the Product Category type')
  ...
  body('color')
    .notEmpty()
    .withMessage('Provide the Product Category color')
    .custom(async (value, { req }) => {
      await ProductCategoryModel.findOne({
        color: value,
        _id: { $ne: req.params.id },
...
exports.updateProductCategoryValidation = [
  ...
  body('category')
    .notEmpty()
    .withMessage('Provide the Product Category name')
    .custom(async (value, { req }) => {
      await ProductCategoryModel.findOne({
        category: value,
        _id: { $ne: req.params.id },
